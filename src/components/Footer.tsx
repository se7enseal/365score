      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            <a href="/privacy" className="text-gray-500 hover:text-white text-sm">隐私政策</a>
            <a href="/terms" className="text-gray-500 hover:text-white text-sm">用户协议</a>
            <a href="/cookies" className="text-gray-500 hover:text-white text-sm">Cookie设置</a>
          </div>
        </div>
      </div>
    </footer>
